...
안녕하세요. 백엔드 개발자를 준비하고 있는 전성입니다.

Java와 Spring Boot를 중심으로 공부하고 있으며, 팀 프로젝트에서는 프론트엔드와 백엔드를 모두 경험했습니다. 제가 만든 기능이 실제 화면에서 의도한 대로 동작하는 모습을 볼 때 가장 뿌듯함을 느낍니다. API를 만든 뒤에는 화면에 직접 연결해 사용해 보면서 오류나 불편한 부분을 찾아 고치는 편입니다.
